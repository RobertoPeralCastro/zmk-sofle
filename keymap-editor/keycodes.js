const ZMK_KEYCODES = {
    ...
    'ES_SEMI': { code: '&kp LS(COMMA)', desc: 'Punto y coma ; (español)' },
    'ES_COLON': { code: '&kp LS(DOT)', desc: 'Dos puntos : (español)' },
    'ES_MINUS': { code: '&kp MINUS', desc: 'Menos - (español)' },
    'ES_PLUS': { code: '&kp LS(RBKT)', desc: 'Más + (español)' },
    'ES_STAR': { code: '&kp STAR', desc: 'Asterisco * (español)' },
